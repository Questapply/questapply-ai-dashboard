...
const RoadmapSection = () => {
  ...
  return (
    <div className="w-full py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-indigo-900/90 via-purple-900/90 to-indigo-800/90">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-4">
            Our <span className="bg-gradient-to-r from-purple-400 to-pink-600 text-transparent bg-clip-text">AI-Powered</span> Roadmap to Success
          </h2>
          
          <p className="text-lg md:text-xl text-center text-purple-200 mb-8">
        ...
        {/* Roadmap Container */}
        <motion.div 
          className="bg-gray-900/60 backdrop-blur-sm border border-purple-500/30 rounded-xl p-6 md:p-8 shadow-xl max-w-4xl mx-auto"
        ...
        >
          ...
          <div className="flex flex-wrap justify-center mb-8 relative">
            ...
            {steps.map((step, index) => (
              <div key={step.id} className="relative z-10 px-1 mb-4 md:mb-0">
                <motion.button
                  className={`relative flex flex-col items-center justify-center w-24 h-24 md:w-28 md:h-28 p-3 rounded-lg transition-all duration-300
                    ${activeStep === step.id 
                      ? 'bg-gradient-to-br from-purple-800 to-indigo-900 shadow-lg scale-105 border border-white/20' 
                      : 'bg-gray-800/80 hover:bg-gray-800 border border-gray-700/50 hover:border-purple-500/50'}`}
                ...
                >
                  ...
                  {/* Step Number */}
                  <div className="absolute -top-2 -left-2 w-6 h-6 rounded-full bg-gray-700 flex items-center justify-center border border-gray-600 text-xs text-white">
                    {step.id}
                  </div>
                </motion.button>
              </div>
            ...
            <div className="mt-6">
              {activeStep === 1 && (
                <div className="space-y-6">
                  {/* Filters */}
                  <motion.div 
                    className="flex flex-wrap gap-2 p-3 bg-gray-800/50 rounded-lg"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.5 }}
                  >
                ...
                <div className="space-y-6">
                  ...
                  {showProgramCards && (
                    ...
                    >
                      ...
                      {[1, 2].map((id) => (
                        <div key={id} className="border border-gray-700 rounded-lg p-5 bg-gray-800/50">
                ...
                <div className="space-y-6">
                  ...
                  {showProfessorCards && (
                    ...
                    >
                      {/* Professor Cards */}
                      {[1, 2, 3, 4].map((id) => (
                        <div key={id} className="border border-gray-700 rounded-lg p-4 bg-gray-800/50 flex items-center space-x-3">
                          <div className="w-12 h-12 rounded-full bg-purple-900/50 flex items-center justify-center text-purple-300 font-bold text-sm">
              ...
              {activeStep === 4 && (
                <motion.div 
                  ...
                  transition={{ duration: 0.5 }}
                >
                  <h3 className="text-lg font-semibold text-white mb-4">Create Resume</h3>
                  <div className="flex space-x-2 overflow-x-auto pb-2 scrollbar-hide">
                    {["Guidance", "Choose Template", "My Resumes", "AI Improvement", "Match with University", "Success Stories", "ATS Analysis"].map((tab) => (
                      <div key={tab} className="px-3 py-1.5 bg-gray-700 rounded-md text-white whitespace-nowrap text-sm">
                        {tab}
                      </div>
                    ))}
                  </div>
              ...
              {activeStep === 5 && (
                <motion.div 
                  ...
                  transition={{ duration: 0.5 }}
                >
                  <h3 className="text-lg font-semibold text-white mb-4">Create Statement of Purpose</h3>
                  <div className="flex space-x-2 overflow-x-auto pb-2 scrollbar-hide">
              ...
              {activeStep === 6 && (
                <motion.div 
                  ...
                  transition={{ duration: 0.5 }}
                >
                  <h3 className="text-lg font-semibold text-white mb-4">Create Letter of Recommendation</h3>
                  <div className="flex space-x-2 overflow-x-auto pb-2 scrollbar-hide">
                ...
                >
                  {!showApplyPopup && !showApplicationForm && (
                    <div className="bg-gray-800/50 p-5 rounded-lg text-center">
                      ...
                      <p className="text-purple-300 text-sm">Click to see your selected programs and begin the application process</p>
                    </div>
                  )}
                  ...
                  {showApplyPopup && (
                    ...
                    >
                      <h3 className="text-lg font-semibold text-white mb-4">Selected Programs</h3>
                      <div className="space-y-3 mb-4">
                        {[
                          ...
                          <div key={program.id} className="border border-gray-700 rounded-lg p-3 bg-gray-700/50">
                            <div className="flex justify-between items-center">
                              <div>
                                <h4 className="text-base font-medium text-white">{program.title}</h4>
                                <p className="text-purple-300 text-sm">{program.school}</p>
                              </div>
                              <Button 
                                variant="outline" 
                  ...
                  {showApplicationForm && (
                    <motion.div 
                      ...
                      transition={{ duration: 0.5 }}
                    >
                      <h3 className="text-lg font-semibold text-white mb-4">Application Options</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="border border-gray-700 rounded-lg p-4 bg-gradient-to-br from-purple-900/30 to-indigo-900/30 hover:from-purple-900/40 hover:to-indigo-900/40 transition-all">
                          <h4 className="text-base font-medium text-white mb-2">Apply Yourself</h4>
                          <p className="text-gray-300 mb-3 text-sm">Apply directly through the university's website using our guidance.</p>
                          <Button className="w-full bg-purple-800 hover:bg-purple-700 text-white" size="sm">
                            Continue
                          </Button>
                        </div>
                        
                        <div 
                          className="border border-indigo-600/30 rounded-lg p-4 bg-gradient-to-br from-indigo-900/30 to-blue-900/30 hover:from-indigo-900/40 hover:to-blue-900/40 transition-all"
                          onClick={handleSubmitWithUs}
                        >
                          <h4 className="text-base font-medium text-white mb-2">Submit with Us</h4>
                          <p className="text-gray-300 mb-3 text-sm">We handle the entire application process on your behalf.</p>
