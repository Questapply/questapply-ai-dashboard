    ...
    <div className="w-full bg-gradient-to-br from-indigo-900/90 via-purple-900/90 to-indigo-800/90 py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.h2 
          ...
          viewport={{ once: true }}
        >
          Our AI-Powered Roadmap to Success
        </motion.h2>
        ...
        {/* Roadmap Container */}
        <motion.div 
          className="bg-gray-900/60 backdrop-blur-sm border border-purple-500/30 rounded-xl p-6 md:p-10 shadow-xl"
          ...
          <div className="flex flex-wrap justify-center mb-12 relative">
            ...
            {steps.map((step, index) => (
              <div key={step.id} className="relative z-10 px-2 mb-6 md:mb-0">
                <motion.button
                  className={`relative flex flex-col items-center justify-center w-36 h-36 md:w-32 md:h-32 p-4 rounded-lg transition-all duration-300
                    ${activeStep === step.id 
                      ? 'bg-gradient-to-br from-purple-800 to-indigo-800 shadow-lg scale-110 border-2 border-white/20' 
