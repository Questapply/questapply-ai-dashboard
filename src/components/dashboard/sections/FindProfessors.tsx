    ...
    <div className="p-6 animate-fade-in">
      ...
      <div className="mb-6">
        <div className="w-full max-w-md relative">
          ...
          <input
            type="text"
            className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 text-sm rounded-lg block w-full pl-10 p-2.5 focus:ring-purple-500 focus:border-purple-500 dark:focus:ring-purple-400 dark:focus:border-purple-400"
              ...
              <div className="flex-grow">
                <div className="flex justify-between">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Button variant="ghost" className="text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                      Create email
                ...
                <div className="mt-4">
                  ...
                  <div className="space-y-2 mt-2">
                    ...
                    <button className="text-purple-600 dark:text-purple-400 text-sm hover:underline mt-2">
                      Show More
                    </button>
                  </div>
                </div>
