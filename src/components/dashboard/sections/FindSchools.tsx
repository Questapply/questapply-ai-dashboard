              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-shrink-0">
                  <img 
                    ...
                    className="w-20 h-20 object-contain bg-gray-100 dark:bg-gray-800 rounded-md p-2"
                  />
                </div>
                ...
                <div className="flex-grow">
                  <div className="flex justify-between">
                    ...
                    <div className="flex gap-2">
                      <Button variant="outline" className="text-purple-600 border-purple-300 dark:border-purple-700 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-colors">
                        School Details
                      </Button>
                      <button
