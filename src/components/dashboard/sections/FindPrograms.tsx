...
const FindPrograms = () => {
  ...
  const getGREStatusStyle = (status: string) => {
    switch (status) {
      case "Not Accepted":
        return "border-red-200 dark:border-red-900 text-red-500 dark:text-red-400";
      case "Optional":
        return "border-yellow-200 dark:border-yellow-900 text-yellow-500 dark:text-yellow-400";
      case "Required":
        return "border-green-200 dark:border-green-900 text-green-500 dark:text-green-400";
      default:
        return "border-gray-200 dark:border-gray-700";
    }
  };

  const getGREIcon = (status: string) => {
    switch (status) {
      case "Not Accepted":
        return "✕";
      case "Optional":
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0">
                    <img 
                      ...
                      className="w-16 h-16 object-contain bg-gray-100 dark:bg-gray-800 rounded-md p-2"
                    />
                  </div>
                ...
                <div className="lg:col-span-2">
                  ...
                  <div className="flex gap-8">
                    <div className="flex flex-col items-center">
                      <div className="rounded-full h-12 w-12 flex items-center justify-center border-4 border-purple-200 dark:border-purple-900 bg-white dark:bg-gray-800 transition-all duration-300 hover:scale-105">
                    ...
                    <div className="flex flex-col items-center">
                      <div className={`rounded-full h-12 w-12 flex items-center justify-center border-4 ${
                        getGREStatusStyle(program.requirements.gre)
                      } bg-white dark:bg-gray-800 transition-all duration-300 hover:scale-105`}>
                        <span className="text-sm font-bold">
                          {getGREIcon(program.requirements.gre)}
                        </span>
                      </div>
