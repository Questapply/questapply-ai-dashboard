...
const testCategories = [
  ...
  },
  {
    ...
    gradient: "bg-gradient-to-r from-green-500/20 to-teal-600/20"
  },
  {
    ...
    <div className="p-6 animate-fade-in">
      <div className="flex flex-col md:flex-row justify-between gap-8 items-start mb-12">
        ...
        <div className="flex-1 max-w-md">
          <div className="relative">
            <div className="absolute -z-10 rounded-full w-72 h-72 bg-gradient-to-r from-purple-400/30 to-blue-400/30 blur-3xl"></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {testCategories.map((category, index) => (
          <motion.div 
            key={index}
            className={`bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden cursor-pointer transform hover:-translate-y-1 ${category.gradient}`}
